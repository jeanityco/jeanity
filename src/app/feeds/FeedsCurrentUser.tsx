...
export function FeedsCurrentUserSidebar() {
  const { name, tag, avatarEmoji, ready } = useAuthSnapshot();
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3 ring-1 ring-white/5">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-violet-400 to-fuchsia-500 text-lg leading-none ring-2 ring-white/10">
        {avatarEmoji || (
